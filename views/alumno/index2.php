                            ...
                            <div class="col-12">
                                <div class="nav-tabs-custom">
                                    <ul class="nav nav-tabs">
                                        ...
                                        <li id="tab_madre"><a href="#madre" data-toggle="tab">Madre de Familia</a></li>
                                        <li id="tab_padre"><a href="#padre" data-toggle="tab">Padre de Familia</a></li>
                                        <li id="tab_apoderado"><a href="#apoderado" data-toggle="tab">Apoderado</a></li>
                                    </ul>
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane" id="madre">
                                            <div class="row">
                                                <div class="col-md-3 form-group">
                                                    ...
                                                    <input <?PHP if($_SESSION['tipo'] != "ADM"){ echo("disabled"); }?> type="text" class="form-control" id="txt_nombres_madre" name="txt_nombres_madre" placeholder="Nombres">
                                                </div>
                                                
                                                <div class="col-md-3">
                                                    <label for="txt_apellidos_madre">Apellidos</label>
                                                    <input <?PHP if($_SESSION['tipo'] != "ADM"){ echo("disabled"); }?> type="text" class="form-control" id="txt_apellidos_madre" name="txt_apellidos_madre" placeholder="Apellidos">
                                                </div>

                                                <div class="col-md-3">
                                                    <label for="txt_correo_madre">Correo</label>
                                                    <input <?PHP if($_SESSION['tipo'] != "ADM"){ echo("disabled"); }?> type="text" class="form-control" id="txt_correo_madre" name="txt_correo_madre" placeholder="Correo">
                                                </div>

                                                <div class="col-md-3">
                                                    <label for="txt_celular_madre">Celular</label>
                                                    <input <?PHP if($_SESSION['tipo'] != "ADM"){ echo("disabled"); }?> type="text" class="form-control" id="txt_celular_madre" name="txt_celular_madre" placeholder="Celular">
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <label for="txt_dni_madre">DNI</label>
                                                    <input <?PHP if($_SESSION['tipo'] != "ADM"){ echo("disabled"); }?> type="text" class="form-control" id="txt_dni_madre" name="txt_dni_madre" placeholder="DNI">
                                                </div>
                                                <div class="col-md-4">
                                                    <label for="txt_direccion_madre">Direccion</label>
                                                    <input <?PHP if($_SESSION['tipo'] != "ADM"){ echo("disabled"); }?> type="text" class="form-control" id="txt_direccion_madre" name="txt_direccion_madre" placeholder="Direccion">
                                                </div>
                                                <div class="col-md-4">
                                                    <label for="txt_fijo_madre">Telefono Fijo</label>
                                                    <input <?PHP if($_SESSION['tipo'] != "ADM"){ echo("disabled"); }?> type="text" class="form-control" id="txt_fijo_madre" name="txt_fijo_madre" placeholder="Telefono Fijo">
                                                </div>
                                            </div>
                                            <div class="row top-buffer">
                                                <div class="col-md-4">
                                        ...
                                        <div class="tab-pane" id="padre">
                                            <div class="row">
                                                <div class="col-md-3 form-group">
                                                    <label for="txt_nombres_padre">Nombres</label>
                                                    <input <?PHP if($_SESSION['tipo'] != "ADM"){ echo("disabled"); }?> type="text" class="form-control" id="txt_nombres_apoderado" name="txt_nombres_apoderado" placeholder="Nombres">
                                                </div>
                                                
                                                <div class="col-md-3">
                                                    <label for="txt_apellidos_padre">Apellidos</label>
                                                    <input <?PHP if($_SESSION['tipo'] != "ADM"){ echo("disabled"); }?> type="text" class="form-control" id="txt_apellidos_apoderado" name="txt_apellidos_apoderado" placeholder="Apellidos">
                                                </div>

                                                <div class="col-md-3">
                                                    <label for="txt_correo_padre">Correo</label>
                                                    <input <?PHP if($_SESSION['tipo'] != "ADM"){ echo("disabled"); }?> type="text" class="form-control" id="txt_correo_apoderado" name="txt_correo_apoderado" placeholder="Correo">
                                                </div>

                                                <div class="col-md-3">
                                                    <label for="txt_celular_padre">Celular</label>
                                                    <input <?PHP if($_SESSION['tipo'] != "ADM"){ echo("disabled"); }?> type="text" class="form-control" id="txt_celular_apoderado" name="txt_celular_apoderado" placeholder="Celular">
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <label for="txt_dni_padre">DNI</label>
                                                    <input <?PHP if($_SESSION['tipo'] != "ADM"){ echo("disabled"); }?> type="text" class="form-control" id="txt_dni_apoderado" name="txt_dni_apoderado" placeholder="DNI">
                                                </div>
                                                <div class="col-md-4">
                                                    <label for="txt_direccion_padre">Direccion</label>
                                                    <input <?PHP if($_SESSION['tipo'] != "ADM"){ echo("disabled"); }?> type="text" class="form-control" id="txt_direccion_apoderado" name="txt_direccion_apoderado" placeholder="Direccion">
                                                </div>
                                                <div class="col-md-4">
                                                    <label for="txt_fijo_padre">Telefono Fijo</label>
                                                    <input <?PHP if($_SESSION['tipo'] != "ADM"){ echo("disabled"); }?> type="text" class="form-control" id="txt_fijo_apoderado" name="txt_fijo_apoderado" placeholder="Telefono Fijo">
                                                </div>
                                            </div>
                                            <div class="row top-buffer">
                                                <div class="col-md-4">
...
<script>
	$(document).ready(function() {
            ...
            "columnDefs":[
                ...
                },    
                {
                    ...
                    "render":function(url, type, full){
                        var datos_madre = full["datos_madre"];
                        if(datos_madre=="SIN DATOS ASIGNADOS"){
                            return '<a href="#">Registrar</a>';
                        }else{
                ...
                },    
                {
                    ...
                    "width":"15%",
                    "render":function(url, type, full){
                        var datos_padre = full["datos_padre"];
                        if(datos_padre=="SIN DATOS ASIGNADOS"){
                            return '<a href="#">Registrar</a>';
                        }else{
                            return '<a href="#">Modificar</a>';
                        }
        ...
        $("#frm_alumno").submit(function(event){
            ...
            var txt_nombres_madre       = $("#txt_nombres_madre").val();
            var txt_apellidos_madre     = $("#txt_apellidos_madre").val();
            var txt_correo_madre        = $("#txt_correo_madre").val();
            var txt_celular_madre       = $("#txt_celular_madre").val();
            var txt_dni_madre           = $("#txt_dni_madre").val();
            var txt_direccion_madre     = $("#txt_direccion_madre").val();
            var txt_fijo_madre          = $("#txt_fijo_madre").val();
            ...
            info["txt_nombres_madre"]       = txt_nombres_madre;
            info["txt_apellidos_madre"]     = txt_apellidos_madre;
            info["txt_correo_madre"]        = txt_correo_madre;
            info["txt_celular_madre"]       = txt_celular_madre;
            info["txt_dni_madre"]           = txt_dni_madre;
            info["txt_direccion_madre"]     = txt_direccion_madre;
            info["txt_fijo_madre"]          = txt_fijo_madre;
